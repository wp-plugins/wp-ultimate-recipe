...
<div class="changelog under-the-hood">
    ...
    <div class="feature-section col three-col">
        <div>
            <h4>Documentation</h4>
            <p>Take a look at <a href="http://www.wpultimaterecipe.com/docs/demo/" target="_blank">our website</a> for documentation on all free and premium features and a collection of <strong>Video Lessons</strong> that show you how to use those features.</p>
        </div>
        <div>
            <h4>Chat with us</h4>
